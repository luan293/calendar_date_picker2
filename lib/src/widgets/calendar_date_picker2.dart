    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          config: widget.config,
          mode: _mode,
          titleYear: widget.config.modePickerTextHandler
                  ?.call(monthDate: _currentDisplayedMonthDate) ??
              _currentDisplayedMonthDate.year.toString(),
          titleMonth: widget.config.modePickerTextHandler
                  ?.call(monthDate: _currentDisplayedMonthDate) ??
              formatMonth(_currentDisplayedMonthDate),
          onTitlePressed: () {
